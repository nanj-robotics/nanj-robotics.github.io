...
All projects below are **solo developed**.
...
FPGA / Digital Design
**[FPGA Project — Title & Details Pending]** · *Jan. 2026 – Apr. 2026*
**Qinnan Jiang**
- *To be completed: please paste the FPGA project description from your LinkedIn (project name, FPGA platform, HDL used, functionality implemented, results).*
