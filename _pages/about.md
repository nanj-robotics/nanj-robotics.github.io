...
<div class='paper-box'><div class='paper-box-image'><div><div class="badge">Robot Arm</div><img src='images/geni_craner.jpg' alt="GeniCraner 7-DOF robot arm with vision-based grasping" style="width: 100%; height: 230px; object-fit: cover; display: block;"></div></div>
...
<div class='paper-box'><div class='paper-box-image'><div><div class="badge">ROS 2 / Navigation</div><img src='images/geni_rover.png' alt="GeniRover autonomous navigation differential-drive mobile robot" style="width: 100%; height: 230px; object-fit: cover; display: block;"></div></div>
<div class='paper-box-text' markdown="1">
...
<div class='paper-box'><div class='paper-box-image'><div><div class="badge">Reinforcement Learning</div><video autoplay loop muted playsinline preload="metadata" aria-label="Quadruped-wheeled robot RL locomotion training in Isaac Gym" style="width: 100%; height: 230px; object-fit: cover; display: block;"><source src="images/quadruped_rl.mp4" type="video/mp4"></video></div></div>
<div class='paper-box-text' markdown="1">
...
<div class='paper-box'><div class='paper-box-image'><div><div class="badge">Motor Control</div><video autoplay loop muted playsinline preload="metadata" aria-label="Dual Robstride RS03 motor synchronous control demonstration" style="width: 100%; height: 230px; object-fit: cover; display: block;"><source src="images/dual_motor_sync.mp4" type="video/mp4"></video></div></div>
<div class='paper-box-text' markdown="1">
...
<div class='paper-box'><div class='paper-box-image'><div><div class="badge">FPGA</div><img src='images/fpga_peak_detection.jpg' alt="FPGA peak detection prototyping on Artix-7" style="width: 100%; height: 230px; object-fit: cover; display: block;"></div></div>
<div class='paper-box-text' markdown="1">
